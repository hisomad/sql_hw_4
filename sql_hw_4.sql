...
/*
Задание 1
Вывыести всех котиков по магазинам по id (условие соединения shops.id = cats.shops_id)
*/
...
/*
Задание 2
Вывести магазин, в котором продаётся кот "Мурзик" (попробуйте выполнить 2 способами)
*/
-- способ с INNER JOIN + WHERE
SELECT s.shopname
FROM shops s
JOIN cats c
ON s.id = c.shops_id
...
/*
Задание 4
Вывести название и цену для всех анализов, которые продавались с 5 февраля 2020 и всю следующую неделю
*/
